...
![Switch Node](assets/images/nodes/switch.png){ width="260" }
...
![Weighted Random Node](assets/images/nodes/weighted-random.png){ width="260" }
...
![Sub Graph Node](assets/images/nodes/sub-graph.png){ width="260" }
