...
<span style="background:#2d6a9f;color:#fff;padding:3px 10px;border-radius:4px;font-size:0.85em;font-weight:bold;">v1.0.1</span> &nbsp; <a href="https://discord.gg/nb8HCuX2h5" style="background:#5865F2;color:#fff;padding:3px 10px;border-radius:4px;font-size:0.85em;font-weight:bold;text-decoration:none;">Discord</a>
